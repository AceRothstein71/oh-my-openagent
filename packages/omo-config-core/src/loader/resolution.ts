...
// Activation is a user-level preference on purpose: a project layer that could pick
// the active profile would indirectly pull in the user-scope-only keys that a
// project layer is not allowed to set itself.
